...
$pdf->SetHeaderData(null, '', 'Listado de Clientes', '');
...
$tbl = $tbl.'
<tr>
  <td width="%5">'. $item['Cliente']['id'] .    '</td>
  <td width="%15">'. $item['Cliente']['nombre'] .'</td>
  <td width="%15">'. $item['Cliente']['apellido'] .'</td>
  <td width="%15">'. $item['Oficio']['descripcion'] .'</td>
  <td width="%15">'. $item['Cliente']['email'] .'</td>
  <td width="%15">'. $item['Cliente']['telefono'] .'</td>
  <td width="%20">'. $item['Cliente']['direccion'] .'</td>
...
echo $pdf->Output(APP . 'files/pdf' . DS . 'listpdfclientes.pdf', 'F');
