	              ...
	              <ul class="treeview-menu">
					...
					<li>
					 <a href="<?php echo $this->Html->url(array('controller' => 'paginas', 'action' => 'promociones')); ?>">
					     <i class="fa fa-circle-o"></i>Ver Promociones</a>
					</li>
					<li>
					 <a href="<?php echo $this->Html->url(array('controller' => 'pagos', 'action' => 'index')); ?>">
					     <i class="fa fa-circle-o"></i>Verificar Pagos</a>
					</li>
             ...
             <li class="treeview">
				<a href="#">
	              ...
	              <ul class="treeview-menu">
					...
					<li>
					 	 <a href="<?php echo $this->Html->url(array('controller' => 'users', 'action' => 'micuentasocio')); ?>">
