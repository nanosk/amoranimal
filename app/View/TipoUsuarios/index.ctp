<div class="tipoUsuarios index">
	...
	<tr>
		...
		<td><?php echo h($tipoUsuario['TipoUsuario']['tipo']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $tipoUsuario['TipoUsuario']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $tipoUsuario['TipoUsuario']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
