...
<tr>
<td><?php echo $item['Talle']['id']; ?></td>
<td><?php echo $item['Talle']['nombre']; ?></td>
<td><?php echo $item['Talle']['descripcion']; ?></td>



<td>
<?php echo $this->Html->link('', array('controller' => 'Talles','action' => 'view', 
$item['Talle']['id']),
...
<?php echo $this->Html->link('', array('controller' => 'Talles','action' => 'edit', 
$item['Talle']['id']),
...
$item['Talle']['descripcion'];
echo $this->Form->postLink('', 
array('controller' => 'Talles','action' => 'delete', $item['Talle']['id']),	
