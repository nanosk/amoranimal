...
<div class="page-header">
	...
	<div id="user-profile-3" class="user-profile row">
				<div class="col-sm-11">
<?php echo $this->Form->create('Marca',array('action'=>'edit','type'=>'file'),array('class'=>'form-horizontal')); ?>
...
<div class="col-xs-4">	
	...
	if (!empty($registro['Marca']['imagen'])) { ?>
	...
	<span class="profile-picture">
	     ...
	     <?php
            ...
            $archivo ='../files/Marca/imagen/'.$registro['Marca']['id'].'/'.$registro['Marca']['imagen'];
