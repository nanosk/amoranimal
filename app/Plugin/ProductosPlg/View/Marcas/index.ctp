...
<td>
<?php
if  ($item['Marca']['imagen']){
echo $this->Html->image('../files/Marca/imagen/'.$item['Marca']['id'].'/'.
			$item['Marca']['imagen'],
...
<td>
<?php echo $this->Html->link('', array('controller' => 'Marcas','action' => 'view', 
$item['Marca']['id']),
...
<?php echo $this->Html->link('', array('controller' => 'Marcas','action' => 'edit', 
$item['Marca']['id']),
...
array('controller' => 'Marcas','action' => 'delete', $item['Marca']['id']),	
