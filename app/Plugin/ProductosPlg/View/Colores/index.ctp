...
<tr>
<td><?php echo $item['Colore']['id']; ?></td>
<td><?php echo $item['Colore']['nombre']; ?></td>
<td><?php echo $item['Colore']['valor']; ?></td>


<td>
<?php echo $this->Html->link('', array('controller' => 'Colores','action' => 'view', 
$item['Colore']['id']),
...
<?php echo $this->Html->link('', array('controller' => 'Colores','action' => 'edit', 
$item['Colore']['id']),
...
array('controller' => 'Colores','action' => 'delete', $item['Colore']['id']),	
