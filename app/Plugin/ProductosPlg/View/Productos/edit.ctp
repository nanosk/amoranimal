...
<div class="page-header">
	...
	<?php echo $this->Form->create('Producto',array('action'=>'edit', 'type'=>'file','class'=>'form-horizontal')); ?>
...
<div class="col-xs-4">	
	...
	if (!empty($registro['Producto']['imagen'])) { ?>
	...
	<span class="profile-picture">
	     ...
	     <?php
            ...
            $archivo ='../files/producto/imagen/'.$registro['Producto']['id'].'/'.$registro['Producto']['imagen'];
